 ...
 */
public class ConnectFireBaseTest {

    private Firestore db;

    public ConnectFireBaseTest(String projectId) throws Exception {
        ...
        FileInputStream serviceAccount = new FileInputStream("./diplom-belyy-pi-2022-firebase-adminsdk-hduuv-812431cf74.json");
    ...
    public static void main(String[] args) throws Exception {
        ...
        ConnectFireBaseTest quickStart = (projectId != null) ? new ConnectFireBaseTest(projectId) : new ConnectFireBaseTest();
        quickStart.run();
        quickStart.close();
    }
